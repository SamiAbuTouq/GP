      ...
      <div className="space-y-1">
        {mainNavItems.map((item) => (
          <Link key={item.href} href={item.href} onClick={onNavigate}>
            <Button
              variant="ghost"
              className={getNavItemClasses(pathname === item.href)}
            >
  ...
  return (
    <div className="flex h-full flex-col bg-sidebar">
      ...
      <div className="border-t border-sidebar-border px-4 py-4 space-y-1">
        <Link href={helpNavItem.href} onClick={onNavigate}>
          <Button
            variant="ghost"
            className={getBottomNavClasses(pathname === helpNavItem.href)}
          >
        ...
        <Button
          variant="ghost"
          className={getBottomNavClasses(false)}
