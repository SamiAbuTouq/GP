...
export const ADMIN_NOTIFICATION_PREF_KEYS = {
  ...
  COURSE_MODIFICATION_REQUESTS: "admin_course_modification_requests",
...
export function mergeNotificationPrefs(raw: unknown): Record<string, boolean> {
  const base: Record<string, boolean> = {
    ...
    [ADMIN_NOTIFICATION_PREF_KEYS.COURSE_MODIFICATION_REQUESTS]: true,
...
export const ALLOWED_NOTIFICATION_PREF_KEYS_BY_ROLE: Record<
  string,
  Set<string>
> = {
