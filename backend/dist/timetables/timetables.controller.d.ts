...
export declare class TimetablesController {
    ...
    list(semesterIdRaw?: string, draftsOnlyRaw?: string, scenarioRunBasesOnlyRaw?: string): Promise<{
        timetableId: any;
        semesterId: any;
        academicYear: any;
        semesterType: any;
    ...
    listConflicts(id: number): Promise<{
        timetableId: number;
    ...
    schedulePayload(id: number): Promise<{
        schedule: {
            lecture_id: string;
    ...
    replaceSchedulePayload(id: number, body: {
        schedule?: unknown[];
    }): Promise<{
        ok: boolean;
        timetableId: number;
